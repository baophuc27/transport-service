...
public class Parameter implements Serializable {
    ...
    public Parameter(@NotNull(message = "id must be not NULL") Long id, @NotNull(message = "connectionId must be not NULL") Long connectionId, @NotNull(message = "organizationId must be not NULL") Long organizationId, @NotNull(message = "englishName must be not NULL") @NotBlank(message = "englishName must be not BLANK") String englishName, @NotNull(message = "vietnameseName must be not NULL") @NotBlank(message = "vietnameseName must be not BLANK") String vietnameseName, @EnumNamePattern(regexp = "CONFIGURE|COMPUTED", message = "parameterType must be in {CONFIGURE, COMPUTED}") ParamType parameterType, @NotNull(message = "indicatorId must be not NULL") Long indicatorId, @NotNull(message = "keyName must be not NULL") @NotBlank(message = "keyName must be not BLANK") String keyName, String displayType, @NotNull(message = "unit must be not NULL") @NotBlank(message = "unit must be not BLANK") String unit, String format, @Valid List<Alarm> alarms) {
        this.id = id;
