...
import com.reeco.ingestion.infrastructure.persistence.postgresql.DeviceEntity;
import com.reeco.ingestion.infrastructure.persistence.postgresql.FtpEntity;
...
public interface DeviceMapper {
    ...
    Device registerCommandToFTPDeviceConnection(RegisterDeviceCommand command);
    ...
    DeviceEntity domainToDeviceEntity(Device deviceConnection);
    ...
    FtpEntity domainToFtpEntity(Device deviceConnection);
}
